...
for Mini Project of Computer Graphics by
	Swati Padmanabhan
	Neha Machhindra
	Sumit Prasad 
*/
...
void main()
{
	...
	setcolor(11);
	outtextxy(250, 50, "A Calculator in C");
	setcolor(12);
	outtextxy(200, 100, "Press the OFF button to exit.");
	y1 = 140;
	y2 = 160;
				...
				if ((x < x2 && x > x1) && (y < y2 && y > y1))
				{
					if ((button & 1) == 1)
					{
						...
						case 24:
							...
							setcolor(12);
							outtextxy(210, 250, "Modified by Sumit's Group.");
							delay(1000);
							setcolor(13);
							exit(0);
							break;
